...
function parseTimeWeather(serebiiEntry) {
  ...
  const result: { time: "Any" as "Any" | "Day" | "Night", weather: "Any" as "Any" | "Sunny" | "Rainy" | "Cloudy" | "Snowy" | "Foggy" } = {
    time: "Any",
    weather: "Any"
  };
...
function timeStringToType(timeStr: string[]): "Any" | "Day" | "Night" {
...
function weatherStringToType(weatherStr: string[]): "Any" | "Sunny" | "Rainy" | "Cloudy" | "Snowy" | "Foggy" {
