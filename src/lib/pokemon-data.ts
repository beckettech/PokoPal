...
const _rawPokemonList: RawPokemon[] = [
  ...
  { id: 382, nationalDex: null, name: "Kyogre", types: ["???"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/382.png", rarity: "Common", specialties: ["???"], locations: [], time: "Any", weather: "Any" },
  { id: 243, nationalDex: null, name: "Raikou", types: ["Generate"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/243.png", rarity: "Common", specialties: ["Generate"], locations: [], time: "Any", weather: "Any" },
  { id: 244, nationalDex: null, name: "Entei", types: ["Burn"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/244.png", rarity: "Common", specialties: ["Burn"], locations: [], time: "Any", weather: "Any" },
  { id: 245, nationalDex: null, name: "Suicune", types: ["Water"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/245.png", rarity: "Common", specialties: ["Water"], locations: [], time: "Any", weather: "Any" },
  { id: 721, nationalDex: null, name: "Volcanion", types: ["Burn"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/721.png", rarity: "Common", specialties: ["Burn"], locations: [], time: "Any", weather: "Any" },
  { id: 144, nationalDex: null, name: "Articuno", types: ["Fly"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/144.png", rarity: "Common", specialties: ["Fly"], locations: [], time: "Any", weather: "Any" },
  { id: 145, nationalDex: null, name: "Zapdos", types: ["Fly"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/145.png", rarity: "Common", specialties: ["Fly"], locations: [], time: "Any", weather: "Any" },
  { id: 146, nationalDex: null, name: "Moltres", types: ["Fly"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/146.png", rarity: "Common", specialties: ["Fly"], locations: [], time: "Any", weather: "Any" },
  { id: 249, nationalDex: null, name: "Lugia", types: ["???"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/249.png", rarity: "Common", specialties: ["???"], locations: [], time: "Any", weather: "Any" },
  { id: 250, nationalDex: null, name: "Ho-Oh", types: ["???"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/250.png", rarity: "Common", specialties: ["???"], locations: [], time: "Any", weather: "Any" },
  { id: 150, nationalDex: null, name: "Mewtwo", types: ["Teleport"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/150.png", rarity: "Common", specialties: ["Teleport"], locations: [], time: "Any", weather: "Any" },
  { id: 151, nationalDex: null, name: "Mew", types: ["Teleport"], habitats: [], image: "https://www.serebii.net/pokemonpokopia/pokemon/151.png", rarity: "Common", specialties: ["Teleport"], locations: [], time: "Any", weather: "Any" },
];
