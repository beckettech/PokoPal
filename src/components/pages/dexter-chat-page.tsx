...
const suggestedPrompts = [
  ...
  { icon: Lightbulb, text: "How do I build a Hot Spring habitat?", color: "bg-orange-100 text-orange-700" },
  { icon: HelpCircle, text: "What's the best habitat for Eevee?", color: "bg-purple-100 text-purple-700" },
  { icon: Sparkles, text: "Tips for attracting rare Pokémon?", color: "bg-pink-100 text-pink-700" },
];
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 0,
      role: "assistant",
      content: "Hey there, Trainer! 👋 I'm Dexter, your Pokopia assistant! I can help you find residents, build habitats, or explore the island. What would you like to know?",
    }
  ]);
      ...
      <div className="pt-12 pb-2 px-4 shrink-0">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] text-white/60">Your Pokopia Assistant</p>
          </div>

          <motion.button
            onClick={() => setCurrentPage("dexter-shop")}
        ...
        <div className="p-3 border-t border-gray-100 bg-white shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 px-3 py-2.5 bg-gray-100 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400"
            />
            <motion.button
              onClick={() => handleSend()}
              disabled={!input.trim()}
          ...
          <p className="text-[10px] text-gray-400 text-center mt-1.5">
            1 message = 1 Dexter Coin • {dexterCoins} coins remaining
          </p>
        </div>
      </div>
    </div>
