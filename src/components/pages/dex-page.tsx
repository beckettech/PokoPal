      ...
      <div className="pt-6 pb-2 px-4 shrink-0">
        ...
        <div className="flex gap-1.5 mt-2 overflow-x-auto pb-1 -mx-1 px-1 scrollbar-hide">
          <button
            ...
            className={`shrink-0 px-2.5 py-1 rounded-full text-[10px] font-medium active:scale-95 transition-transform ${!selectedSpecialty ? "bg-white dark:bg-gray-800 text-red-600" : "bg-white/20 text-white"}`}
          >
            All Specs
          </button>
          {allSpecialties.map(spec => (
            <button
              ...
              className={`shrink-0 px-2.5 py-1 rounded-full text-[10px] font-medium active:scale-95 transition-transform ${selectedSpecialty === spec ? "bg-emerald-500 text-white" : "bg-white/20 text-white"}`}
            >
              {spec}
            </button>
          ))}
