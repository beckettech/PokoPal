...
const DREAM_ISLANDS = [
  {
    id: "pikachu",
    name: "Pikachu Island",
    doll: { name: "Pikachu Doll", image: "/items/pikachudoll.png" },
    materials: [
      { name: "Leppa Berry", image: "/items/leppaberry.png" },
      { name: "Vine Rope", image: "/items/vinerope.png" },
      { name: "Copper Ore", image: "/items/copperore.png" },
      { name: "Gold Ore", image: "/items/goldore.png" },
      { name: "Glowing Mushrooms", image: "/items/glowingmushrooms.png" },
      { name: "Pokémetal Fragment", image: "/items/pokemetalfragment.png" },
    ],
    rareItems: [
      { name: "Twine", image: "/items/twine.png" },
      { name: "Seaglass Fragments", image: "/items/seaglassfragments.png" },
      { name: "Seashell", image: "/items/seashell.png" },
    ],
    legendaries: [
      { name: "Raikou", image: "/pokemon/243.png", chance: 25, tip: "Search in the 2 separate caves to look for small rooms with walls made from different materials than the surrounding area." },
    ],
  ...
  },
  {
    id: "eevee",
    name: "Eevee Island",
    doll: { name: "Eevee Doll", image: "/items/eeveedoll.png" },
    materials: [
      { name: "Leppa Berry", image: "/items/leppaberry.png" },
      { name: "Vine Rope", image: "/items/vinerope.png" },
      { name: "Glowing Mushrooms", image: "/items/glowingmushrooms.png" },
    ...
    rareItems: [
      { name: "Mossy Stone", image: "/items/mossystone.png" },
      { name: "Squishy Clay", image: "/items/squishyclay.png" },
    ],
    legendaries: [
      { name: "Suicune", image: "/pokemon/245.png", chance: 25, tip: "Search in the 2 separate caves to look for small rooms with walls made from different materials than the surrounding area." },
    ],
  ...
  },
  {
    ...
    materials: [
      { name: "Iron Ore", image: "/items/ironore.png" },
      { name: "Gold Ore", image: "/items/goldore.png" },
    ...
    legendaries: [
      { name: "Entei", image: "/pokemon/244.png", chance: 25, tip: "Search in the 2 separate caves to look for small rooms with walls made from different materials than the surrounding area." },
    ],
  ...
  },
  {
    ...
    doll: { name: "Dragonite Doll", image: "/items/dragonitedoll.png" },
    materials: [
      { name: "Wastepaper", image: "/items/wastepaper.png" },
      { name: "Pokémetal Fragment", image: "/items/pokemetalfragment.png" },
      { name: "Crystal Fragment", image: "/items/crystalfragment.png" },
      { name: "Iron Ore", image: "/items/ironore.png" },
    ],
    ...
    legendaries: [
      { name: "Mewtwo", image: "/pokemon/150.png", chance: 10, tip: "Complete the 'Rebuild the huge building!' quest in Sparkling Skylands (build floors 2F→3F→4F), then meet Mewtwo on the roof to unlock this encounter." },
    ],
  ...
  },
  {
    id: "ditto",
    name: "Ditto Island",
    doll: { name: "Ditto Doll", image: "/items/dittodoll.png" },
    materials: [
      { name: "Random Materials", image: "/items/random.png" },
    ],
    rareItems: [],
    legendaries: [],
  ...
  },
  {
    ...
    doll: { name: "Substitute Doll", image: "/items/substitutedoll.png" },
    materials: [
      { name: "Random Materials", image: "/items/random.png" },
    ],
    rareItems: [],
